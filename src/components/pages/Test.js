...
const AudioPlayer_useStyles = makeStyles((theme) => {
  return {
    root: {
      width: "95%",
      margin: "10px auto",
...
export default function Test() {
  ...
  useEffect(() => {
    if (
      symptom.swelling === "yes" &&
      symptom.Redness === "yes" &&
      symptom.Bleeding === "yes" &&
      symptom.BreathingDifficulty === "yes"
    )
      setType("Venomous snake");
    else setType("Non-venomous snake");
  });
              ...
              <Grid>
                ...
                <Grid item>
                  <div style={{ width: "fit-content", margin: "auto" }}>
                    <FormControl value="1" classes={{ root: classes.DropMain }}>
                      <InputLabel classes={{ root: classes.DropDownLabel }}>
                        Symptoms
                      </InputLabel>
                      <Select
                        placeholder="Symptomss"
                        name={x.name}
                        label="symp"
                        className={classes.DropDrown}
                ...
                <Dialog open={Dialogs[x.name]}>
                  <DialogTitle>
                    ...
                    <img
                      src="https://image.shutterstock.com/image-photo/first-aid-training-snake-bite-600w-1009656238.jpg"
                      alt="first aid"
                      style={{
                        height: "150px",
                        display: "block",
                    ...
                    >
                      <AudioPlayer
                        useStyles={AudioPlayer_useStyles}
                        autoplay={true}
